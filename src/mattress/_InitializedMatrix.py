...
class InitializedMatrix:
    """
    Pointer to an object containing a ``tatami::Matrix``, typically generated by :py:func:`~mattress.initialize` for use in C++ code.
    ...
    def __init__(self, ptr: int):
        """
        This constructor should only be called by registered methods for :py:func:`~mattress.initialize`.
